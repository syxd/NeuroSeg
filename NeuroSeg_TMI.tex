...
%
To reconstruct dense neuronal populations from a terabyte-sized ultra-scale image, we introduce an automatic framework which adaptively traces neurons block by block and \zj{fuses multiple neurons} in overlapped regions continuously and smoothly.
%
