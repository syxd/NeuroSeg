...
We cropped patches of size $160\times 160\times 8$ as input to the network, considering unequal image sizes along three dimensions and the axial resolution is usually much lower in the images of the BigNeuron dataset.
We also perform data augmentation by rotating the training images along different dimensions.
}
...
%
Our UltraNPR takes about $45$ hours \xj{34+1+10, in hours for segmentation, for reconstruction, for block propagation respectively} to reconstruct the image on a cluster computer with $64$ GB of working memory and 20 NVIDIA 1080Ti GPUs.
%
