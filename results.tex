...
\begin{figure}[t]
	...
	\caption{F-Score of neuron reconstruction on the VISoR-40 test dataset \xj{the whole dataset?} at five iterations. Combining any one of the three neuron segmentation networks, our approach progressively improves the reconstruction performance.}
