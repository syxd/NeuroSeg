...
\begin{table*}[th]
	...
	\begin{tabular}{lcccc}
		...
		%\hline
		APP2~\cite{Xiao2013}
		& \textbf{0.980} & 0.115 & 0.191 & 0.119\\
		SmartTracing~\cite{Chen2015}
		& 0.877 & 0.291 & 0.400 & 0.242\\
		TReMAP~\cite{Zhou2016}
		& 0.917 & 0.199 & 0.326 & 0.203\\
		MOST~\cite{Wu2014}          
		& 0.969 & 0.284& 0.434& 0.316\\
		APP1~\cite{Peng2011}
		& 0.935 & 0.201 & 0.328 & 0.205\\
		FMST~\cite{Yang2019}
		& 0.884 & 0.208 & 0.335 &  0.211\\
		NGPST~\cite{Quan2015}
		& 0.978 & 0.603 & 0.741 & 0.623\\
		\midrule
		Ours
		& 0.971 & \textbf{0.829}&\textbf{0.893} & \textbf{0.833}\\
		\bottomrule
	\end{tabular}
\end{table*}
...
\begin{table*}[th]
	\centering
	\caption{Performance comparison with different methods for neuronal population reconstruction on the VISoR-40 dataset.}
	\label{table:compare_enhanced_img_VISoR}
	\begin{tabular}{lcccc}
		\toprule
		Method & Precision & Recall & F-Score & Jaccard\\
		\midrule
		%\hline
		APP2~\cite{Xiao2013}
		& \textbf{0.973} & 0.447 & 0.604 & 0.480\\
		SmartTracing~\cite{Chen2015}
		& 0.917 & 0.622 & 0.701 & 0.480\\
		TReMAP~\cite{Zhou2016}
		& 0.906 & 0.421 & 0.573 & 0.429\\
		MOST~\cite{Wu2014}          
		& 0.953 & 0.597 & 0.725 & 0.655\\
		APP1~\cite{Peng2011}
		& 0.930 & 0.516 & 0.658 & 0.507\\
		FMST~\cite{Yang2019}
		& 0.916 & 0.435 & 0.588 &  0.439\\
		Ours
		& 0.971 & \textbf{0.829}&\textbf{0.893} & \textbf{0.833}\\
		\bottomrule
	\end{tabular}
...
\begin{table*}[]
	...
	\begin{tabular}{lcccc|cccc}
		...
		\hline
		\multicolumn{1}{l}{APP2~\cite{Xiao2013}} & 0.980 & 0.115 & 0.191 & 0.119 & 0.973 & 0.447 & 0.604 & 0.480\\
		...
		\multicolumn{1}{l}{NGPST~\cite{Quan2015}} & 0.978 & 0.603 & 0.741 & 0.623 & 0.971 & 0.829 & 0.893 & 0.833\\
		\hline
	\end{tabular}
\end{table*}
...
\begin{table*}[]
	...
	\begin{tabular}{l|cc|cc|cc|cc}
		\hline
		\multirow{2}{*}{Method} & \multicolumn{2}{c|}{Precision}  & \multicolumn{2}{c|}{Recall} & \multicolumn{2}{c|}{F-Score} & \multicolumn{2}{c}{Jaccard}\\ 
		\cline{2-9}
		& Raw & Enhanced & Raw & Enhanced & Raw & Enhanced & Raw & Enhanced \\ 
		\hline
		\multicolumn{1}{l|}{APP2~\cite{Xiao2013}} & 0.980 & 0.973 & 0.115 & 0.447 & 0.191 & 0.604 & 0.119  & 0.480\\
		\multicolumn{1}{l|}{SmartTracing~\cite{Chen2015}} & 0.877 & 0.917 & 0.291 & 0.622 & 0.400 & 0.701 & 0.242 & 0.480\\
		\multicolumn{1}{l|}{TReMAP~\cite{Zhou2016}} & 0.917 & 0.906 & 0.199 & 0.421 & 0.326 & 0.573 & 0.203 & 0.429\\
		\multicolumn{1}{l|}{MOST~\cite{Wu2014} } & 0.969 & 0.953 & 0.284 & 0.597 & 0.434 & 0.725 & 0.316 
		& 0.655\\
		\multicolumn{1}{l|}{APP1~\cite{Peng2011}} & 0.935 & 0.930 & 0.201 & 0.516 & 0.328 & 0.658  & 0.205 
		& 0.507\\
		\multicolumn{1}{l|}{FMST~\cite{Yang2019}} & 0.884 & 0.916 & 0.208 & 0.435 & 0.335 & 0.588 &  0.211 
		&  0.439\\
		\multicolumn{1}{l|}{NGPST~\cite{Quan2015}} & 0.978 & 0.971 & 0.603 & 0.829 & 0.741 & 0.893 & 0.623 & 0.833\\
		\hline
	\end{tabular}
\end{table*}
...
\begin{table*}[th]
	...
	\begin{tabular}{lcccccccc}
		...
		APP2~\cite{Xiao2013} & \textbf{0.799} & 0.607 & 0.654 & 0.631 & 13.457 & 17.923 & 0.562\\
		TReMAP~\cite{Zhou2016} & 0.771 & 0.508 & 0.578 & 0.525 & 11.269 & 17.941 & 0.539\\
		NGPST~\cite{Quan2015} & 0.710 & 0.757 & 0.728 & 0.592 & 10.168 & 14.880 & 0.587\\
		SmartTracing~\cite{Chen2015} & 0.701 & 0.722 & 0.613 & 0.465 & 10.430 & 13.430 & 0.547\\
		MEIT~\cite{Wang2018} & 0.689  & 0.729 & 0.702 & 0.396 & 12.068 &16.578 & 0.554 \\
		UltraTracer~\cite{Peng2017} & 0.796 & 0.685 & 0.705 & 0.682 & 9.578 & 14.197 & 0.452 \\
		Li2017~\cite{Li2017} & - & - & - & - & 4.917 & \textbf{7.972} &0.461 \\
		\midrule
		Ours & 0.769 & \textbf{0.777} & \textbf{0.768} & \textbf{0.683} & \textbf{4.784} & 8.309 & \textbf{0.451}\\
		\bottomrule
	\end{tabular}
\end{table*}
