...
Each testing block is first labeled manually and independently by two experts. Then, by cross-checking each other's result, their agreed annotation is approved by an expert \xj{the third one?} to generate the final ground truth.
