...
Although NGPST~\cite{Quan2015} achieves better performance of neuronal identity \xj{what do you mean by neuronal identity? identification? separation?}, it still remains difficult to extract subtle neuron voxels for NGPST by using hand-crafted features.
%
